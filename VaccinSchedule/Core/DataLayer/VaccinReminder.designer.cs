...
namespace VaccinSchedule.Core.DataLayer
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="dbVaccinReminder")]
	public partial class VaccinReminderDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InserttblReminderToday(tblReminderToday instance);
    partial void UpdatetblReminderToday(tblReminderToday instance);
    partial void DeletetblReminderToday(tblReminderToday instance);
    partial void InserttblVaccine(tblVaccine instance);
    partial void UpdatetblVaccine(tblVaccine instance);
    partial void DeletetblVaccine(tblVaccine instance);
    partial void InserttblVaccineType(tblVaccineType instance);
    partial void UpdatetblVaccineType(tblVaccineType instance);
    partial void DeletetblVaccineType(tblVaccineType instance);
    ...
    partial void Deletewebpages_Role(webpages_Role instance);
		...
		public VaccinReminderDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["dbVaccinReminderConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public VaccinReminderDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public VaccinReminderDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public VaccinReminderDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public VaccinReminderDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<tblReminderToday> tblReminderTodays
		{
			get
			{
				return this.GetTable<tblReminderToday>();
			}
		}
		
		public System.Data.Linq.Table<tblVaccine> tblVaccines
		{
			get
			{
				return this.GetTable<tblVaccine>();
			}
		}
		
		public System.Data.Linq.Table<tblVaccineType> tblVaccineTypes
		{
			get
			{
				return this.GetTable<tblVaccineType>();
			}
		}
		
		public System.Data.Linq.Table<tblVaccineUser> tblVaccineUsers
		{
			get
			{
				return this.GetTable<tblVaccineUser>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.tblReminderToday")]
	public partial class tblReminderToday : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Guid _UserVaccineId;
		
		private string _UserName;
		
		private string _Message;
		
		private string _EmailChanelState;
		
		private string _YahooChanelState;
		
		private string _SkypeChanelState;
		
		private string _FacebookChanelState;
		
		private string _SMSChanelState;
    ...
    partial void OnUserVaccineIdChanging(System.Guid value);
    partial void OnUserVaccineIdChanged();
    partial void OnUserNameChanging(string value);
    partial void OnUserNameChanged();
    partial void OnMessageChanging(string value);
    partial void OnMessageChanged();
    partial void OnEmailChanelStateChanging(string value);
    partial void OnEmailChanelStateChanged();
    partial void OnYahooChanelStateChanging(string value);
    partial void OnYahooChanelStateChanged();
    partial void OnSkypeChanelStateChanging(string value);
    partial void OnSkypeChanelStateChanged();
    partial void OnFacebookChanelStateChanging(string value);
    partial void OnFacebookChanelStateChanged();
    partial void OnSMSChanelStateChanging(string value);
    partial void OnSMSChanelStateChanged();
    partial void OnUserIdChanging(System.Nullable<System.Guid> value);
    partial void OnUserIdChanged();
    #endregion
		
		public tblReminderToday()
		{
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_UserVaccineId", DbType="UniqueIdentifier NOT NULL")]
		public System.Guid UserVaccineId
		{
			get
			{
				return this._UserVaccineId;
			}
			set
			{
				if ((this._UserVaccineId != value))
				{
					this.OnUserVaccineIdChanging(value);
					this.SendPropertyChanging();
					this._UserVaccineId = value;
					this.SendPropertyChanged("UserVaccineId");
					this.OnUserVaccineIdChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_EmailChanelState", DbType="NVarChar(50)")]
		public string EmailChanelState
		{
			get
			{
				return this._EmailChanelState;
			}
			set
			{
				if ((this._EmailChanelState != value))
				{
					this.OnEmailChanelStateChanging(value);
					this.SendPropertyChanging();
					this._EmailChanelState = value;
					this.SendPropertyChanged("EmailChanelState");
					this.OnEmailChanelStateChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_YahooChanelState", DbType="NVarChar(50)")]
		public string YahooChanelState
		{
			get
			{
				return this._YahooChanelState;
			}
			set
			{
				if ((this._YahooChanelState != value))
				{
					this.OnYahooChanelStateChanging(value);
					this.SendPropertyChanging();
					this._YahooChanelState = value;
					this.SendPropertyChanged("YahooChanelState");
					this.OnYahooChanelStateChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SkypeChanelState", DbType="NVarChar(50)")]
		public string SkypeChanelState
		{
			get
			{
				return this._SkypeChanelState;
			}
			set
			{
				if ((this._SkypeChanelState != value))
				{
					this.OnSkypeChanelStateChanging(value);
					this.SendPropertyChanging();
					this._SkypeChanelState = value;
					this.SendPropertyChanged("SkypeChanelState");
					this.OnSkypeChanelStateChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FacebookChanelState", DbType="NVarChar(50)")]
		public string FacebookChanelState
		{
			get
			{
				return this._FacebookChanelState;
			}
			set
			{
				if ((this._FacebookChanelState != value))
				{
					this.OnFacebookChanelStateChanging(value);
					this.SendPropertyChanging();
					this._FacebookChanelState = value;
					this.SendPropertyChanged("FacebookChanelState");
					this.OnFacebookChanelStateChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SMSChanelState", DbType="NVarChar(50)")]
		public string SMSChanelState
		{
			get
			{
				return this._SMSChanelState;
			}
			set
			{
				if ((this._SMSChanelState != value))
				{
					this.OnSMSChanelStateChanging(value);
					this.SendPropertyChanging();
					this._SMSChanelState = value;
					this.SendPropertyChanged("SMSChanelState");
					this.OnSMSChanelStateChanged();
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.tblVaccine")]
	public partial class tblVaccine : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private System.Guid _VaccineId;
		
		private System.Guid _VaccineTypeId;
		
		private string _Name;
		
		private string _Description;
		
		private System.Nullable<int> _MinDay;
		
		private System.Nullable<int> _MaxDay;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnVaccineIdChanging(System.Guid value);
    partial void OnVaccineIdChanged();
    partial void OnVaccineTypeIdChanging(System.Guid value);
    partial void OnVaccineTypeIdChanged();
    partial void OnNameChanging(string value);
    partial void OnNameChanged();
    partial void OnDescriptionChanging(string value);
    partial void OnDescriptionChanged();
    partial void OnMinDayChanging(System.Nullable<int> value);
    partial void OnMinDayChanged();
    partial void OnMaxDayChanging(System.Nullable<int> value);
    ...
    partial void OnLastUpdatedChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_VaccineId", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		public System.Guid VaccineId
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_VaccineTypeId", DbType="UniqueIdentifier NOT NULL")]
		public System.Guid VaccineTypeId
		{
			get
			{
			...
			set
			{
				if ((this._VaccineTypeId != value))
				{
					this.OnVaccineTypeIdChanging(value);
					this.SendPropertyChanging();
					this._VaccineTypeId = value;
					this.SendPropertyChanged("VaccineTypeId");
					this.OnVaccineTypeIdChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MinDay", DbType="Int")]
		public System.Nullable<int> MinDay
		{
			get
			{
				return this._MinDay;
			...
			set
			{
				if ((this._MinDay != value))
				{
					this.OnMinDayChanging(value);
					this.SendPropertyChanging();
					this._MinDay = value;
					this.SendPropertyChanged("MinDay");
					this.OnMinDayChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MaxDay", DbType="Int")]
		public System.Nullable<int> MaxDay
		{
			get
			{
				return this._MaxDay;
			...
			set
			{
				if ((this._MaxDay != value))
				{
					this.OnMaxDayChanging(value);
					this.SendPropertyChanging();
					this._MaxDay = value;
					this.SendPropertyChanged("MaxDay");
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.tblVaccineType")]
	public partial class tblVaccineType : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnIsActiveChanged();
		...
		public tblVaccineType()
		{
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_VaccineTypeId", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		public System.Guid VaccineTypeId
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.tblVaccineUser")]
	public partial class tblVaccineUser : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private System.Guid _VaccineUserId;
		
		private System.Guid _VaccineId;
		
		private System.Nullable<System.DateTime> _RemainingStartDate;
		
		private System.Nullable<System.DateTime> _RemainingEndDate;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnVaccineUserIdChanging(System.Guid value);
    partial void OnVaccineUserIdChanged();
    partial void OnVaccineIdChanging(System.Guid value);
    partial void OnVaccineIdChanged();
    partial void OnRemainingStartDateChanging(System.Nullable<System.DateTime> value);
    partial void OnRemainingStartDateChanged();
    partial void OnRemainingEndDateChanging(System.Nullable<System.DateTime> value);
    partial void OnRemainingEndDateChanged();
    partial void OnActualDateChanging(System.Nullable<System.DateTime> value);
    partial void OnActualDateChanged();
    partial void OnIsInjectedChanging(bool value);
    partial void OnIsInjectedChanged();
    ...
    partial void OnUserIdChanged();
		...
		public tblVaccineUser()
		{
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_VaccineUserId", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		public System.Guid VaccineUserId
		{
			get
			{
				return this._VaccineUserId;
			}
			set
			{
				if ((this._VaccineUserId != value))
				{
					this.OnVaccineUserIdChanging(value);
					this.SendPropertyChanging();
					this._VaccineUserId = value;
					this.SendPropertyChanged("VaccineUserId");
					this.OnVaccineUserIdChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_VaccineId", DbType="UniqueIdentifier NOT NULL")]
		public System.Guid VaccineId
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_RemainingStartDate", DbType="DateTime")]
		public System.Nullable<System.DateTime> RemainingStartDate
		{
			get
			{
				return this._RemainingStartDate;
			}
			set
			{
				if ((this._RemainingStartDate != value))
				{
					this.OnRemainingStartDateChanging(value);
					this.SendPropertyChanging();
					this._RemainingStartDate = value;
					this.SendPropertyChanged("RemainingStartDate");
					this.OnRemainingStartDateChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_RemainingEndDate", DbType="DateTime")]
		public System.Nullable<System.DateTime> RemainingEndDate
		{
			get
			{
				return this._RemainingEndDate;
			}
			set
			{
				if ((this._RemainingEndDate != value))
				{
					this.OnRemainingEndDateChanging(value);
					this.SendPropertyChanging();
					this._RemainingEndDate = value;
					this.SendPropertyChanged("RemainingEndDate");
					this.OnRemainingEndDateChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IsInjected", DbType="Bit NOT NULL")]
		public bool IsInjected
		{
			...
			set
			{
				if ((this._IsInjected != value))
				{
					this.OnIsInjectedChanging(value);
					this.SendPropertyChanging();
					this._IsInjected = value;
					this.SendPropertyChanged("IsInjected");
					this.OnIsInjectedChanged();
				}
			}
		}
